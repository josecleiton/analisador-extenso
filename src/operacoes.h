...
char* completaMenor (char a[], char b[], char* menor); /* COLOCA ZEROS NA MENOR STRING */
...
bool strIsDigit (char a[]); /* VERIFICA SE A STRING É TODA NUMERICA (ASCII OU INT) */
...
void trataZeros (char** ptrNumber); /* IGNORA OS ZEROS E RETORNA EM PTRNUMBER UMA NOVA STRING SEM ELES */
void ignoraZero (int narg, ...); /* ESPERA QUANTOS ARGUMENTOS E UM PONTEIRO PARA STRING */
